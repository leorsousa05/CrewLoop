  ...
  const simulationSteps: TerminalStep[] = [
    {
      ...
      logs: [
        ...
        { id: '5', type: 'output', text: 'Installed 8 skill(s) to ~/.agents/skills/' },
        { id: '6', type: 'output', text: '  + crewloop-hub' },
        { id: '7', type: 'output', text: '  + crewloop-plan' },
        { id: '8', type: 'output', text: '  + crewloop-design' },
        { id: '9', type: 'output', text: '  + crewloop-code' },
        { id: '10', type: 'output', text: '  + crewloop-review' },
        { id: '11', type: 'output', text: '  + crewloop-ship' },
        { id: '12', type: 'output', text: '  + crewloop-brainstorm' },
        { id: '13', type: 'output', text: '  + crewloop-docs' },
        { id: '14', type: 'output', text: '' },
        { id: '15', type: 'output', text: 'Configured agent hooks:' },
        { id: '16', type: 'success', text: '  ✓ claude (configured)' },
        { id: '17', type: 'success', text: '  ✓ kimi (configured)' },
        { id: '18', type: 'output', text: '' },
        { id: '19', type: 'success', text: 'Run "crewloop dashboard" to start receiving hook events.' }
      ],
      durationAfter: 3500
    },
    {
