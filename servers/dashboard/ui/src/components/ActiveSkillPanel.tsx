...
export function ActiveSkillPanel({ session }: Props) {
  ...
  const skill = session.activeSkill || { name: 'UNKNOWN', confidence: 'unknown' };
  ...
  return (
    <section className="panel p-6">
      ...
      <div className="flex flex-col gap-4">
        <div className="w-16 h-16 rounded-xl bg-elevated border border-border-default flex items-center justify-center text-accent">
